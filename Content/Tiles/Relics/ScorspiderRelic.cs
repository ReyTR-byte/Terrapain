...
namespace Terrapain.Content.Tiles.Relics
{
    public class ScorspiderRelic : ModTile
    {
        ...
        public virtual string RelicTextureName => "Terrapain/Content/Tiles/Relics/ScorspiderRelic";

        // All relics use the same pedestal texture, this one is copied from vanilla
        public override string Texture => "Terrapain/Content/Tiles/Relics/RelicPedestal";
        ...
        public override void KillMultiTile(int i, int j, int frameX, int frameY)
        {
            ...
            {
                case 0:
                    itemType = ModContent.ItemType<Items.Placeable.Relics.ScorspiderRelic>();
                    break;
