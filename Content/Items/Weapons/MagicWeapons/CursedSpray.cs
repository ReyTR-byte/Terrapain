...
{
	public class CursedSpray : ModItem
	{
		...
		public override void SetDefaults() {
			...
			Item.autoReuse = true;
			Item.shoot = ModContent.ProjectileType<GlassBouble>(); // Shoot a black bolt, also known as the projectile shot from the onyx blaster.
