...
{
    public class GranithBook : ModItem
    {
        ...
        public override void SetDefaults()
        {
            ...
            Item.autoReuse = true;
            Item.shoot = ModContent.ProjectileType<CobwebBullet>(); // Shoot a black bolt, also known as the projectile shot from the onyx blaster.
        ...
        {
            velocity = velocity.RotatedByRandom(0.0125f * (float)Math.PI);
        }
