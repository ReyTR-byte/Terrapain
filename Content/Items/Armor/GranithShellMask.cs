...
namespace Terrapain.Content.Items.Armor
{
	...
	public class GranithShellMask : ModItem
	{
		...
		{
            player.setBonus = Language.GetTextValue("Mods.Terrapain.SetBonus.GranithShellMask");
			player.GetModPlayer<TerrapainPlayer>().RangerGranithShellArmorSet = true;
			player.GetDamage(DamageClass.Ranged) += 0.1f;
			player.ammoCost75 = true;
			if (player.HeldItem.DamageType == DamageClass.Ranged)
			{
				player.HeldItem.GetGlobalItem<TGlobalItem>().ShootSpeedBonus += 2;
			}
		}
		...
		public override void AddRecipes()
		{
            ...
            recipe.AddIngredient<ScorspiderCobweb>(2);
